...
const messages = [
    "Gửi đến người con gái tuyệt vời nhất trong cuộc đời em, mẹ xíu mang đến niềm vui và hạnh phúc cho mỗi ngày.",
    "Những câu chửi của mẹ xíu thắp sáng thế giới của em, và tình yêu của mẹ xíu lấp đầy trái tim em bằng sự ấm áp.",
    "Vào ngày đặc biệt này, em muốn mẹ xíu biết mẹ xíu có ý nghĩa như thế nào đối với em.",
    "Mẹ xíu không chỉ là ngửi iu của em, mà là cả thế giới của em.",
    "Em trân trọng từng khoảnh khắc chúng ta bên nhau, và em mong muốn tạo ra nhiều kỷ niệm đẹp hơn nữa.",
    "Chúc mừng Ngày Phụ nữ, mẹ xíu của em! Mừng mẹ xíu có một ngày mùng 8/3 vui vẽ và hạnh phúc."
];
